...
export function Hero() {
  ...
  return (
    <Section>
      <div
        className="h-120 rounded-xl bg-cover bg-bottom bg-no-repeat relative"
        style={{ backgroundImage: `url(${banner.src})` }}
      >
        <div className="absolute left-0 top-0 bg-black/60 h-120 w-full rounded-xl content-end">
